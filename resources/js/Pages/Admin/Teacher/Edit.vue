...
const form = useForm({
  ...
  identity_id: props.teacher.identity_id || '',
  english_level: props.teacher.english_level,
  id_user: props.teacher.id_user || ''
})
...
<template>
  <LayoutAuthenticated>
    ...
    <SectionMain>
      ...
      <CardBox
        form
        @submit.prevent="form.put(route('admin.teacher.update', teacher.id))"
      >
